...
sudo apt-get clean
mkdir -p ~/.vnc
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/APT/XFCE4/xstartup -P ~/.vnc/
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/APT/XFCE4/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/APT/XFCE4/vncserver-stop -P /usr/local/bin/
...
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Uninstall/ubchromiumfix.sh && chmod +x ubchromiumfix.sh
