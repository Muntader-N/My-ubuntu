...
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Pacman/Manjaro/XFCE/vncserver-start -O /usr/local/bin/vncserver-start
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Pacman/Manjaro/XFCE/vncserver-stop -O /usr/local/bin/vncserver-stop
...
vncpasswd
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Pacman/tigervnc-fix.sh -O ~/tigervnc-fix.sh && bash ~/tigervnc-fix.sh
