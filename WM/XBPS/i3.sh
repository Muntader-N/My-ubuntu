...
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/XBPS/XFCE4/vncserver-start -O /usr/local/bin/vncserver-start
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/XBPS/XFCE4/vncserver-stop -O /usr/local/bin/vncserver-stop
