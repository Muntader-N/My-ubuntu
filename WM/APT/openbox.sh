...
case "$choice" in 
  y|Y ) wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Uninstall/ubchromiumfix.sh && chmod +x ubchromiumfix.sh && ./ubchromiumfix.sh && rm -rf ubchromiumfix.sh ;;
...
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/WM/wallpaper.jpg -O /usr/share/wallpaper.jpg
echo "#!/bin/bash
...
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/APT/LXDE/vncserver-start -O /usr/local/bin/vncserver-start
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/APT/LXDE/vncserver-stop -O /usr/local/bin/vncserver-stop
