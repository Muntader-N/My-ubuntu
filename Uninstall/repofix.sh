...
if [ -d "$folder" ]; then
    ...
    wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Uninstall/mirrorlist -O $folder/etc/pacman.d/mirrorlist
...
if [ -d "$folder2" ]; then
    ...
    wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Uninstall/mirrorlist -O $folder2/etc/pacman.d/mirrorlist
