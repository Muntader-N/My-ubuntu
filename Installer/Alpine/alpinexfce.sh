...
if [ "$check" -eq "1" ] > /dev/null 2>&1; then
	...
	*)
	...
	url=https://github.com/Muntader-N/My-ubuntu/blob/master/Rootfs/Alpine/${archurl}/alpine-minirootfs-3.10.3-${archurl}.tar.gz?raw=true
...
if [ -d $folder/var ];then
	...
	rm -rf $folder/root/.bash_profile
  	echo "#!/bin/bash
              wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Installer/Alpine/alpine-xfce.sh -O /root/alpine-xfce.sh
