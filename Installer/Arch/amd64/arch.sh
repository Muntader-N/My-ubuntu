...
wget "https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Installer/Arch/amd64/resolv.conf" -P arch-fs/root > /dev/null
wget "https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Installer/Arch/amd64/additional.sh" -P arch-fs/root > /dev/null
