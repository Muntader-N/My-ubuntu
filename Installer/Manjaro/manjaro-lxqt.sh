...
pkg install wget -y 
folder=manjaro-fs
dlink="https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Pacman/Manjaro"
if [ -d "$folder" ]; then
    first=1
...
if [ "$first" != 1 ];then
    wget --tries=20 https://github.com/Muntader-N/My-ubuntu/raw/master/Rootfs/Manjaro/manjaro.partaa -O manjaro.partaa
    wget --tries=20 https://github.com/Muntader-N/My-ubuntu/raw/master/Rootfs/Manjaro/manjaro.partab -O manjaro.partab
    wget --tries=20 https://github.com/Muntader-N/My-ubuntu/raw/master/Rootfs/Manjaro/manjaro.partac -O manjaro.partac
...
wget https://raw.githubusercontent.com/Muntader-N/My-ubuntu/master/Pacman/Manjaro/LXQT/xstartup -O $folder/root/.vnc/xstartup
